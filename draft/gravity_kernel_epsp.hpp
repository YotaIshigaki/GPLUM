...
__fkg_tmp8 = _mm256_mul_ps(qxx,rij.v0);
__fkg_tmp7 = _mm256_fmadd_ps(qxy,rij.v1,__fkg_tmp8);
qr.v0 = _mm256_fmadd_ps(qzx,rij.v2,__fkg_tmp7);
__fkg_tmp10 = _mm256_mul_ps(qyy,rij.v1);
__fkg_tmp9 = _mm256_fmadd_ps(qyz,rij.v2,__fkg_tmp10);
qr.v1 = _mm256_fmadd_ps(qxy,rij.v0,__fkg_tmp9);
__fkg_tmp12 = _mm256_mul_ps(qzz,rij.v2);
__fkg_tmp11 = _mm256_fmadd_ps(qzx,rij.v0,__fkg_tmp12);
qr.v2 = _mm256_fmadd_ps(qyz,rij.v1,__fkg_tmp11);
__fkg_tmp14 = _mm256_fmadd_ps(qr.v0,rij.v0,mtr);
__fkg_tmp13 = _mm256_fmadd_ps(qr.v1,rij.v1,__fkg_tmp14);
rqr = _mm256_fmadd_ps(qr.v2,rij.v2,__fkg_tmp13);
rqr_r4_inv = _mm256_mul_ps(rqr,r4_inv);
meff = _mm256_fmadd_ps(_mm256_set1_ps(0.5f),rqr_r4_inv,mjloc);
__fkg_tmp15 = _mm256_fmadd_ps(_mm256_set1_ps(2.5f),rqr_r4_inv,mjloc);
meff3 = _mm256_mul_ps(__fkg_tmp15,r3_inv);
pf = _mm256_fnmadd_ps(meff,r_inv,pf);
__fkg_tmp16 = _mm256_fnmadd_ps(r5_inv,qr.v0,af.v0);
af.v0 = _mm256_fmadd_ps(meff3,rij.v0,__fkg_tmp16);
__fkg_tmp17 = _mm256_fnmadd_ps(r5_inv,qr.v1,af.v1);
af.v1 = _mm256_fmadd_ps(meff3,rij.v1,__fkg_tmp17);
__fkg_tmp18 = _mm256_fnmadd_ps(r5_inv,qr.v2,af.v2);
af.v2 = _mm256_fmadd_ps(meff3,rij.v2,__fkg_tmp18);
} // loop of j

{
__m256 __fkg_tmp_accum;
int index_gather_load0[8] = {0,8,16,24,32,40,48,56};
...
{
__m256 __fkg_tmp_accum;
int index_gather_load1[8] = {0,8,16,24,32,40,48,56};
...
{
__m256 __fkg_tmp_accum;
int index_gather_load2[8] = {0,8,16,24,32,40,48,56};
...
{
__m256 __fkg_tmp_accum;
int index_gather_load3[8] = {0,8,16,24,32,40,48,56};
...
__fkg_tmp5 = (eps2*tr);
mtr = -(__fkg_tmp5);
__fkg_tmp8 = (qxx*rij.x);
__fkg_tmp7 = (qxy*rij.y+__fkg_tmp8);
qr.x = (qzx*rij.z+__fkg_tmp7);
__fkg_tmp10 = (qyy*rij.y);
__fkg_tmp9 = (qyz*rij.z+__fkg_tmp10);
qr.y = (qxy*rij.x+__fkg_tmp9);
__fkg_tmp12 = (qzz*rij.z);
__fkg_tmp11 = (qzx*rij.x+__fkg_tmp12);
qr.z = (qyz*rij.y+__fkg_tmp11);
__fkg_tmp14 = (qr.x*rij.x+mtr);
__fkg_tmp13 = (qr.y*rij.y+__fkg_tmp14);
rqr = (qr.z*rij.z+__fkg_tmp13);
rqr_r4_inv = (rqr*r4_inv);
meff = (0.5f*rqr_r4_inv+mjloc);
__fkg_tmp15 = (2.5f*rqr_r4_inv+mjloc);
meff3 = (__fkg_tmp15*r3_inv);
pf = (pf - meff*r_inv);
__fkg_tmp16 = (af.x - r5_inv*qr.x);
af.x = (meff3*rij.x+__fkg_tmp16);
__fkg_tmp17 = (af.y - r5_inv*qr.y);
af.y = (meff3*rij.y+__fkg_tmp17);
__fkg_tmp18 = (af.z - r5_inv*qr.z);
af.z = (meff3*rij.z+__fkg_tmp18);
} // loop of j
...
if(j<nj){ // tail j loop
__m256x3 __fkg_tmp19;

__fkg_tmp19.v0 = af.v0;
__fkg_tmp19.v1 = af.v1;
__fkg_tmp19.v2 = af.v2;
__m256 __fkg_tmp20;
...
af.v0 = _mm256_blend_ps(__fkg_tmp19.v0,af.v0,0b00000001);
af.v1 = _mm256_blend_ps(__fkg_tmp19.v1,af.v1,0b00000001);
af.v2 = _mm256_blend_ps(__fkg_tmp19.v2,af.v2,0b00000001);
pf = _mm256_blend_ps(__fkg_tmp20,pf,0b00000001);
} // if of j tail loop
