...
class RealPtcl{
	...
	void writeAscii(FILE* fp) const{
#if 0
		fprintf(fp, "%ld\t%ld\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\n",  this->tag,  this->mat,  this->mass,  this->pos.x,  this->pos.y,  this->pos.z,  this->vel.x,  this->vel.y,  this->vel.z,  this->acc.x,  this->acc.y,  this->acc.z, this->div_v, sqrt(this->rot_v * this->rot_v), this->dens);
#else
		fprintf(fp, "%ld\t%ld\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16le\t%.16le\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\t%.16lf\n",
			  	this->tag,  this->mat,  this->mass,  
				this->pos.x,  this->pos.y,  this->pos.z,  
				this->vel.x,  this->vel.y,  this->vel.z, 
				this->eng_dot, this->dt,
			   	this->acc.x,  this->acc.y,  this->acc.z,
			   	this->div_v, sqrt(this->rot_v * this->rot_v), this->dens);
#endif
		//fprintf(fp, "%ld\t%ld\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\n",  this->tag,  this->mat,  this->mass,  this->pos.x,  this->pos.y,  this->pos.z,  this->vel.x,  this->vel.y,  this->vel.z,  this->dens,  this->eng,  this->pres);
	}
