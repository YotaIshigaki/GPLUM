...
void SetupIC(PS::ParticleSystem<RealPtcl>& sph_system, system_t& sysinfo, PS::DomainInfo& dinfo){
	...
	//const int Nx = 322; // 512node(4096proc) 32k/core
	//const int Nx = 161; // 64node(512proc) 32k/core 
	//const int Nx = 81; // 8node(64proc) 32k/core 
	//const int Nx = 41; // 1node(8proc) 32k/core 
    // XC30
    //const int Nx = 257;   // 64node(2064core) 32k/core    
    const int Nx = 233;   // 64node(1536core) 32k/core    
    //const int Nx = 116;   // 8node(192core) 32k/core    
    //const int Nx = 58; // 1node(24core) 32k/core
    //// Nx=(8k*ncore)^(1/3) ////
