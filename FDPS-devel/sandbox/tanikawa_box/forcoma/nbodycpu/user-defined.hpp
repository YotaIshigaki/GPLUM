...
void CalcGravity(const FPGrav * iptcl,
    ...
    const PS::S32 nimax  = 1024;
    const PS::S32 njmax  = 65536;
    assert(ni <= nimax)
    assert(nj <= 65536);
    static __thread PS::F64 xi[nimax][3];
    static __thread PS::F64 ai[nimax][3];
    static __thread PS::F64 pi[nimax];
    static __thread PS::F64 xj[njmax][3];
    static __thread PS::F64 mj[njmax];
