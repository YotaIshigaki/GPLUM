...
TARGET2 = reproduce_check-iwasawa.out

#MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_debug
#MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_gb_160k
#MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_gb_120k
#MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_gb_80k
#MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_gb_60k
#MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_gb_40k
#MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_gb_20k_1
MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_gb_10k_1
#MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_reproduce
...
compile_check:
	ssh $(NSCCWX) "cd $(MY_DIR); make distclean; make -B $(TARGET2)"

submit_gb_160k:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 160000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 10000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

submit_gb_120k:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 120000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 10000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

submit_gb_80k:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 80000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 15000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

submit_gb_60k:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 60000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 10000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"
...
submit_gb_10k:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 10000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 15000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

submit:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_expr -n 16 -cgsp 64 -share_size 6500 -host_stack 512 ./$(TARGET) -N 1000000 -n 1024 -t 0.2 -l 16 > 00stdout.log 2>&1"

submit_check:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 60000 -cgsp 64 -share_size 6500 -host_stack 512 ./$(TARGET2) -N 1000000 -n 1024 -t 0.2 -l 16 > 00stdout.log 2>&1"
