...
TARGET = nbody-iwasawa.out

#MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_r1709
MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_debug_02
...
remove_src:
	ssh $(NSCCWX) "mkdir -p $(MY_DIR); cd $(MY_DIR); rm -f cpe_kernel/*.*; rm -f result/*.*; rm -f src/*.*; rm -f ./*"

send_src:
	ssh $(NSCCWX) "mkdir -p $(MY_DIR); cd $(MY_DIR); \
	mkdir -p ./src/; mkdir -p ./cpe_kernel/; mkdir -p ./result; \
	rm -f result/*.*"
	rsync -av --include='src' --include='src/*.hpp' --include='cpe_kernel' --include='cpe_kernel/*.c' --include='cpe_kernel/*.h' --include='Makefile' --include="*.h" --include="*.hpp" --include="*.c" --include="*.cpp" --exclude='*' ./ $(NSCCWX):$(MY_DIR)

compile:
	ssh $(NSCCWX) "cd $(MY_DIR); make distclean; make -B $(TARGET)"

submit_gb_40k:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 40000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 10000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

submit_gb_20k:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 20000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 10000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

submit_gb_10k:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 10000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 10000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

#for check lage scale job
submit_gb_2k:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 2000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 10000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

#for check lage scale job
submit_large:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_share -n 1024 -cgsp 64 -share_size 6500 -host_stack 512 ./$(TARGET) -N 10000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

submit_middle:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_share -n 100 -cgsp 64 -share_size 6500 -host_stack 512 ./$(TARGET) -N 2000000 -n 1024 -t 0.2 -l 16 > 00stdout.log 2>&1"

#submit:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_expr -n 16 -cgsp 64 -share_size 6500 -host_stack 512 ./$(TARGET) -N 16384 -n 128 -t 0.5 -l 16 > 00stdout.log 2>&1"

#for developing
submit:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_expr -n 16 -cgsp 64 -share_size 6500 -host_stack 512 ./$(TARGET) -N 131072 -n 1024 -t 0.2 -l 16 > 00stdout.log 2>&1"

submit_small:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_expr -n 16 -cgsp 64 -share_size 6500 -host_stack 512 ./$(TARGET) -N 20000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

#submit_debug:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 70 -cgsp 64 -share_size 6500 -host_stack 512 ./$(TARGET) -N 20000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

#submit_debug:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 200 -cgsp 64 -share_size 6500 -host_stack 512 ./$(TARGET) -N 20000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

#submit_debug:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 1000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 1000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

#submit_debug:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 1000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 10000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

# There is BUG cond.
#submit_debug:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 10000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 1000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

# OK
#submit_debug:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 5000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 1000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

#OK
#submit_debug:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 100 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 1000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

# There is BUG cond.
#submit_debug:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 10000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 100000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

#OK
#submit_debug:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 6000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 50000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

# TARGET COND (also -n 7990, 7980)
#submit_debug:
#	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 8000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 50000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"
...
submit_debug:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_share -n 16 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 100000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"

get_log:
	mkdir -p result
	rsync -avx $(NSCCWX):$(MY_DIR)/00stdout.log ./result

get_snp:
	mkdir -p result
	rsync -avx $(NSCCWX):$(MY_DIR)/result/snp_000??_00000.dat ./result
#	rsync -avx $(NSCCWX):$(MY_DIR)/result/snp_000??_000??.dat ./result
#	rsync -avx $(NSCCWX):$(MY_DIR)/00stdout.log ./result

get:
	rsync -avx $(NSCCWX):$(MY_DIR)/result/debug_00000.dat ./

get_all:
	rsync -avx $(NSCCWX):$(MY_DIR)/result ./

sc: send_src compile

scs: send_src compile submit

scsl: send_src compile submit_large

scsm: send_src compile submit_middle

scss: send_src compile submit_small

scsgb: send_src compile submit_gb

scsgbm: send_src compile submit_gb_middle

scsgb20k: send_src compile submit_gb_20k

scsgb40k: send_src compile submit_gb_40k

scsgb2k: send_src compile submit_gb_2k
