...
module fdps_vector
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_v32_i(v,i)
      type(fdps_f32vec), intent(inout) :: v
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_v32_f(v,f)
      type(fdps_f32vec), intent(inout) :: v
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_v32_d(v,d)
      type(fdps_f32vec), intent(inout) :: v
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_v32_v32(a,b)
      type(fdps_f32vec), intent(inout) :: a
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_v32_v64(a,b)
      type(fdps_f32vec), intent(inout) :: a
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_v64_i(v,i)
      type(fdps_f64vec), intent(inout) :: v
      integer(kind=c_int), intent(in) :: i
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_v64_f(v,f)
      type(fdps_f64vec), intent(inout) :: v
      real(kind=c_float), intent(in) :: f
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_v64_d(v,d)
      type(fdps_f64vec), intent(inout) :: v
      real(kind=c_double), intent(in) :: d
      v%x = d
      v%y = d
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_v64_v32(a,b)
      type(fdps_f64vec), intent(inout) :: a
      type(fdps_f32vec), intent(in) :: b
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_v64_v64(a,b)
      type(fdps_f64vec), intent(inout) :: a
      type(fdps_f64vec), intent(in) :: b
      a%x = b%x
      a%y = b%y
   ...
   !####################################################################
   elemental type(fdps_f32vec) function add_v32_v32(a,b)
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function add_v32_v64(a,b)
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function add_v64_v32(a,b)
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function add_v64_v64(a,b)
   ...
   !####################################################################
   elemental type(fdps_f32vec) function sub_v32_v32(a,b)
      type(fdps_f32vec), intent(in) :: a,b
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function sub_v32_v64(a,b)
      type(fdps_f32vec), intent(in) :: a
      type(fdps_f64vec), intent(in) :: b
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function sub_v64_v32(a,b)
      type(fdps_f64vec), intent(in) :: a
      type(fdps_f32vec), intent(in) :: b
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function sub_v64_v64(a,b)
      type(fdps_f64vec), intent(in) :: a,b
   ...
   !====================================================================
   elemental type(fdps_f32vec) function neg_v32(v)
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function neg_v64(v)
   ...
   !####################################################################
   elemental type(fdps_f32vec) function mul_v32_i(v,i)
      type(fdps_f32vec), intent(in) :: v
      integer(kind=c_int), intent(in) :: i
      mul_v32_i%x = v%x * i
      mul_v32_i%y = v%y * i
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32vec) function mul_v32_f(v,f)
      type(fdps_f32vec), intent(in) :: v
      real(kind=c_float), intent(in) :: f
      mul_v32_f%x = v%x * f
      mul_v32_f%y = v%y * f
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32vec) function mul_v32_d(v,d)
      type(fdps_f32vec), intent(in) :: v
      real(kind=c_double), intent(in) :: d
      mul_v32_d%x = v%x * d
      mul_v32_d%y = v%y * d
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32vec) function mul_i_v32(i,v)
      integer(kind=c_int), intent(in) :: i
      type(fdps_f32vec), intent(in) :: v
      mul_i_v32%x = i * v%x 
      mul_i_v32%y = i * v%y 
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32vec) function mul_f_v32(f,v)
      real(kind=c_float), intent(in) :: f
      type(fdps_f32vec), intent(in) :: v
      mul_f_v32%x = f * v%x 
      mul_f_v32%y = f * v%y 
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32vec) function mul_d_v32(d,v)
      real(kind=c_double), intent(in) :: d
      type(fdps_f32vec), intent(in) :: v
      mul_d_v32%x = d * v%x 
      mul_d_v32%y = d * v%y 
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function mul_v64_i(v,i)
      type(fdps_f64vec), intent(in) :: v
      integer(kind=c_int), intent(in) :: i
      mul_v64_i%x = v%x * i
      mul_v64_i%y = v%y * i
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function mul_v64_f(v,f)
      type(fdps_f64vec), intent(in) :: v
      real(kind=c_float), intent(in) :: f
      mul_v64_f%x = v%x * f
      mul_v64_f%y = v%y * f
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function mul_v64_d(v,d)
      type(fdps_f64vec), intent(in) :: v
      real(kind=c_double), intent(in) :: d
      mul_v64_d%x = v%x * d
      mul_v64_d%y = v%y * d
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function mul_i_v64(i,v)
      integer(kind=c_int), intent(in) :: i
      type(fdps_f64vec), intent(in) :: v
      mul_i_v64%x = i * v%x 
      mul_i_v64%y = i * v%y 
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function mul_f_v64(f,v)
      real(kind=c_float), intent(in) :: f
      type(fdps_f64vec), intent(in) :: v
      mul_f_v64%x = f * v%x 
      mul_f_v64%y = f * v%y 
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function mul_d_v64(d,v)
      real(kind=c_double), intent(in) :: d
      type(fdps_f64vec), intent(in) :: v
      mul_d_v64%x = d * v%x 
      mul_d_v64%y = d * v%y 
   ...
   !--------------------------------------------------------------------
   elemental real(kind=c_float) function mul_v32_v32(a,b)
      type(fdps_f32vec), intent(in) :: a,b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION 
   ...
   !--------------------------------------------------------------------
   elemental real(kind=c_double) function mul_v64_v32(a,b)
      type(fdps_f64vec), intent(in) :: a
      type(fdps_f32vec), intent(in) :: b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION 
   ...
   !--------------------------------------------------------------------
   elemental real(kind=c_double) function mul_v32_v64(a,b)
      type(fdps_f32vec), intent(in) :: a
      type(fdps_f64vec), intent(in) :: b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION 
   ...
   !--------------------------------------------------------------------
   elemental real(kind=c_double) function mul_v64_v64(a,b)
      type(fdps_f64vec), intent(in) :: a,b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION 
   ...
   !####################################################################
   elemental type(fdps_f32vec) function div_v32_i(v,i)
      type(fdps_f32vec), intent(in) :: v
      integer(kind=c_int), intent(in) :: i
      div_v32_i%x = v%x / i
      div_v32_i%y = v%y / i
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32vec) function div_v32_f(v,f)
      type(fdps_f32vec), intent(in) :: v
      real(kind=c_float), intent(in) :: f
      div_v32_f%x = v%x / f
      div_v32_f%y = v%y / f
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32vec) function div_v32_d(v,d)
      type(fdps_f32vec), intent(in) :: v
      real(kind=c_double), intent(in) :: d
      div_v32_d%x = v%x / d
      div_v32_d%y = v%y / d
   ...
   !====================================================================
   elemental type(fdps_f64vec) function div_v64_i(v,i)
      type(fdps_f64vec), intent(in) :: v
      integer(kind=c_int), intent(in) :: i
      div_v64_i%x = v%x / i
      div_v64_i%y = v%y / i
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function div_v64_f(v,f)
      type(fdps_f64vec), intent(in) :: v
      real(kind=c_float), intent(in) :: f
      div_v64_f%x = v%x / f
      div_v64_f%y = v%y / f
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64vec) function div_v64_d(v,d)
      type(fdps_f64vec), intent(in) :: v
      real(kind=c_double), intent(in) :: d
      div_v64_d%x = v%x / d
      div_v64_d%y = v%y / d
