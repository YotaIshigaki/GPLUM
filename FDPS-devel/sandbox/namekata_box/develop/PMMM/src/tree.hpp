...
namespace ParticleSimulator{
    ...
    // for PM^3
    typedef SPJMonopoleInOnly                  SPJMonopolePMMM;
    typedef SPJQuadrupoleInOnly                SPJQuadrupolePMMM;
    typedef SPJMonopoleGeometricCenterInOnly   SPJMonopoleGeometricCenterPMMM;
    typedef SPJDipoleGeometricCenterInOnly     SPJDipoleGeometricCenterPMMM;
    typedef SPJQuadrupoleGeometricCenterInOnly SPJQuadrupoleGeometricCenterPMMM;
