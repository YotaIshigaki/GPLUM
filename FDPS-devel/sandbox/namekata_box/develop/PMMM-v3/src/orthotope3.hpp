...
namespace ParticleSimulator{
    ...
    public:
        ...
        unsigned int isNotContainedBy(const Orthotope3 & a) const {
            const Vector3<T> a_high = a.high_;
            const Vector3<T> a_low = a.low_;
            const Vector3<T> b_high = this->high_;
            const Vector3<T> b_low = this->low_;
        ...
        unsigned int isContainedBy(const Orthotope3 & a) const {
        ...
        unsigned int doesNotContain(const Orthotope3 & a) const {
        ...
        unsigned int contains(const Orthotope3 & a) const {
