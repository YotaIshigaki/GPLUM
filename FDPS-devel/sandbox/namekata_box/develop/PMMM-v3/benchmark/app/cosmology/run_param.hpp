...
public:
    ...
    void input_params(FILE * param_fp) {
        ...
        output_timing = (COSM::real_t *)malloc(sizeof(COSM::real_t)*noutput);
        output_indx = 0;

        COSM::real_t prev_output_timing=0.0;
    ...
    void update_expansion(COSM::real_t tnow) {
        COSM::real_t om, ov;
    ...
    void output_diag(PS::F64 dtime) {
        ...
        if (mpi_rank == 0) {
            ...
            if (step == 0) {
                ...
                const double walltime = wt_now - wt_prev;
                fprintf(diag_fp,
