...
static __thread_local volatile dma_desc dma_get, dma_put;
...
static void UpdateTc(etcLM *tc_tgt,
    ...
    volatile epjLM epj[CHUNK_SIZE];
    volatile etcLM tc [N_CHILDREN];
...
void CalcMomentLean(void *args) {
    ...
    volatile etcLM tc_tgt[CHUNK_SIZE];
