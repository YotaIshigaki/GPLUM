...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsubsection{PS::EXCHANGE_LET_MODE型}
...
%\subsubsubsection{EXCHANGE_LET_P2P_FAST}

%LETの交換に{\tt MPI\_Alltoall}を使用せず、{\tt MPI\_Allgather}と{\tt
%MPI\_Isend/recv}を使用する。結果はPS::EXCHANGE\_LET\_P2P\_EXACTを用い
%た場合と異なるが、より通信量が減っているため、高速に動作する可能性があ
%る。
