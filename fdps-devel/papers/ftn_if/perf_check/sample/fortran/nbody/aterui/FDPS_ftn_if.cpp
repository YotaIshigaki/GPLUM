...
void fdps_sort_particle00000(const int psys_num,
                             bool (*pfunc_comp)(const struct full_particle & left,
                                                const struct full_particle & right)) {
   sort_particle00000(psys_num,pfunc_comp);
}
