...
void SetupIC(PS::ParticleSystem<RealPtcl>& sph_system, system_t& sysinfo, PS::DomainInfo& dinfo){
    ...
    //const int Nx = 64;   // for   24 cores
//    const int Nx = 128;  // for  192 cores
    const int Nx = 256;    // for 1536 cores

	const PS::F64 dx = 1.0 / (double)(Nx);// for 64 nodes
	//const PS::F64 dx = 1.0 / 128.0;//128 for 512 nodes
	//const PS::F64 dx = 1.0 / 256.0;// for 4096 nodes
	//const PS::F64 dx = 1.0 / 512.0;// for 32768 nodes
	//const PS::F64 dx = 1.0 / (512.0 * 1.08);// for 41500 nodes
	//const PS::F64 dx = 1.0 / (512.0 * 1.36);//for 82944 nodes
