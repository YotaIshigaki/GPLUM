...
namespace ParticleSimulator{
    ...
    static const long long int LIMIT_NUMBER_OF_TREE_PARTICLE_PER_NODE = 1ll<<31;
...
#pragma omp critical
    ...
    public:
        ...
        F64 add_moment_as_sp_local; // for reuse list
        F64 add_moment_as_sp_global; // for reuse list
        F64 make_ipg;

        // not public
        F64 morton_key_local_tree;
        F64 morton_sort_local_tree;
        F64 morton_sort_local_tree__reorder;
        F64 link_cell_local_tree;
        F64 morton_key_global_tree;
        F64 morton_sort_global_tree;
        F64 morton_sort_global_tree__reorder;
        ...
        F64 getSum() const {
            return  collect_sample_particle 
                + decompose_domain
                + exchange_particle
                + set_particle_local_tree
                + set_particle_global_tree
                + make_local_tree
                + make_global_tree
                + set_root_cell
                + calc_force
                ...
                + exchange_LET_2nd
                + write_back
                + add_moment_as_sp_local
                + add_moment_as_sp_global
                + make_ipg;
        }

        void dump(std::ostream & fout=std::cout) const {
            fout<<"sum= "<<getSum()<<std::endl;
            ...
            fout<<"    morton_key_local_tree= "<<morton_key_local_tree<<std::endl;
            fout<<"    morton_sort_local_tree= "<<morton_sort_local_tree<<std::endl;
            fout<<"        morton_sort_local_tree__sort_key= "<<morton_sort_local_tree-morton_sort_local_tree__reorder<<std::endl;
            fout<<"        morton_sort_local_tree__reorder= "<<morton_sort_local_tree__reorder<<std::endl;
            fout<<"    link_cell_local_tree= "<<link_cell_local_tree<<std::endl;
            fout<<"  make_global_tree= "<<make_global_tree<<std::endl;
            fout<<"    morton_key_global_tree= "<<morton_key_global_tree<<std::endl;
            fout<<"    morton_sort_global_tree= "<<morton_sort_global_tree<<std::endl;
            fout<<"        morton_sort_global_tree__sort_key= "<<morton_sort_global_tree-morton_sort_global_tree__reorder<<std::endl;
            fout<<"        morton_sort_global_tree__reorder= "<<morton_sort_global_tree__reorder<<std::endl;
            ...
            fout<<"    calc_force__wb_int_cp= "<<calc_force__wb_int_cp<<std::endl;
            ...
            fout<<"  add_moment_as_sp_glboal= "<<add_moment_as_sp_global<<std::endl;
            fout<<"  make_ipg= "<<make_ipg<<std::endl;
        }
        ...
        TimeProfile () {
            ...
            make_ipg = 0.0;
            morton_key_local_tree = morton_sort_local_tree = link_cell_local_tree
                = morton_key_global_tree = morton_sort_global_tree = link_cell_global_tree = 0.0;
            ...
            morton_sort_local_tree__reorder = morton_sort_global_tree__reorder = 0.0;
        ...
        TimeProfile operator + (const TimeProfile & rhs) const{
            ...
            ret.morton_key_local_tree = this->morton_key_local_tree + rhs.morton_key_local_tree;
            ...
            ret.morton_key_global_tree = this->morton_key_global_tree + rhs.morton_key_global_tree;
	    ...
	    ret.calc_force__core__retrieve = this->calc_force__core__retrieve + rhs.calc_force__core__retrieve;
            ...
            ret.calc_force__wb_int_cp = this->calc_force__wb_int_cp + rhs.calc_force__wb_int_cp;
            ...
            ret.make_ipg = this->write_back + rhs.make_ipg;

            ret.morton_sort_local_tree__reorder = this->morton_sort_local_tree__reorder + rhs.morton_sort_local_tree__reorder;
            ret.morton_sort_global_tree__reorder = this->morton_sort_global_tree__reorder + rhs.morton_sort_global_tree__reorder;
            return ret;
        }
	    ...
	    */
            return collect_sample_particle + decompose_domain + exchange_particle + set_particle_local_tree + set_particle_global_tree + make_local_tree 
                + make_global_tree + set_root_cell
                + calc_force + calc_moment_local_tree + calc_moment_global_tree + make_LET_1st + make_LET_2nd + exchange_LET_1st + exchange_LET_2nd
                + morton_key_local_tree  + morton_sort_local_tree  + link_cell_local_tree 
                + morton_key_global_tree + morton_sort_global_tree + link_cell_global_tree
