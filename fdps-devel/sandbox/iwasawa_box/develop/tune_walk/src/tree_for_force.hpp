...
namespace ParticleSimulator{
    ...
    public:
        //F64 length_; // full length of a side of the root cell
...
// probably, calcMomentGlobalTreeOnlyImpl is classified depending on force_type.
        ...
        //void checkMortonSortLocalTreeOnlyImpl(TagForceLong, std::ostream & fout);
        //void checkMortonSortLocalTreeOnlyImpl(TagForceShort, std::ostream & fout);
