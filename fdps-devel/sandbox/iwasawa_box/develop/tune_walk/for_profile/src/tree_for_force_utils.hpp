...
//#ifdef __HPC_ACE__
        ...
        //const __m256i zero_i32 = _mm256_set1_epi32(0);
        ...
        /*
        const S32 nc0 = tc_first[adr_tc+0].n_ptcl_;
        const S32 nc1 = tc_first[adr_tc+1].n_ptcl_;
        const S32 nc2 = tc_first[adr_tc+2].n_ptcl_;
        const S32 nc3 = tc_first[adr_tc+3].n_ptcl_;
        const S32 nc4 = tc_first[adr_tc+4].n_ptcl_;
        const S32 nc5 = tc_first[adr_tc+5].n_ptcl_;
        const S32 nc6 = tc_first[adr_tc+6].n_ptcl_;
        const S32 nc7 = tc_first[adr_tc+7].n_ptcl_;
        __m256i nc = _mm256_setr_epi32(nc0, nc1, nc2, nc3, nc4, nc5, nc6, nc7);
        open_bits = _mm256_movemask_ps(_mm256_castsi256_ps(_mm256_cmpgt_epi32(nc, zero_i32)));
        */
	    ...
	    N_CALL_TRAVERSE++;
            ...
            if(n_child == 0){
                ...
                if( !(tc_child->isLeaf(n_leaf_limit)) ){
                    ...
                    ep_list.resizeNoInitialize(ep_list.size()+n_ep_tmp);
                    sp_list.resizeNoInitialize(sp_list.size()+n_sp_tmp);
#else
                    /*
                    for(S32 ip=0; ip<n_child; ip++){
                        if( GetMSB(tp_first[adr_ptcl_tmp].adr_ptcl_) == 0){
