...
module fdps_matrix
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_m32_i(m,i)
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_m32_f(m,f)
      type(fdps_f32mat), intent(inout) :: m
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_m32_d(m,d)
      type(fdps_f32mat), intent(inout) :: m
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_m32_m32(a,b)
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_m32_m64(a,b)
      type(fdps_f32mat), intent(inout) :: a
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_m64_i(m,i)
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_m64_f(m,f)
      type(fdps_f64mat), intent(inout) :: m
      real(kind=c_float), intent(in) :: f
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      m%xx = f
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_m64_d(m,d)
      type(fdps_f64mat), intent(inout) :: m
      real(kind=c_double), intent(in) :: d
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      m%xx = d
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_m64_m32(a,b)
   ...
   !--------------------------------------------------------------------
   elemental subroutine set_m64_m64(a,b)
      type(fdps_f64mat), intent(inout) :: a
      type(fdps_f64mat), intent(in) :: b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      a%xx = b%xx
   ...
   !####################################################################
   elemental type(fdps_f32mat) function add_m32_m32(a,b)
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function add_m32_m64(a,b)
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function add_m64_m32(a,b)
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function add_m64_m64(a,b)
      type(fdps_f64mat), intent(in) :: a
      type(fdps_f64mat), intent(in) :: b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
   ...
   !####################################################################
   elemental type(fdps_f32mat) function sub_m32_m32(a,b)
      type(fdps_f32mat), intent(in) :: a,b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function sub_m32_m64(a,b)
      type(fdps_f32mat), intent(in) :: a
      type(fdps_f64mat), intent(in) :: b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function sub_m64_m32(a,b)
      type(fdps_f64mat), intent(in) :: a
      type(fdps_f32mat), intent(in) :: b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function sub_m64_m64(a,b)
      type(fdps_f64mat), intent(in) :: a
      type(fdps_f64mat), intent(in) :: b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
   ...
   !####################################################################
   elemental type(fdps_f32mat) function mul_m32_i(m,i)
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32mat) function mul_m32_f(m,f)
      type(fdps_f32mat), intent(in) :: m
      real(kind=c_float), intent(in) :: f
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      mul_m32_f%xx = m%xx * f
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32mat) function mul_m32_d(m,d)
      type(fdps_f32mat), intent(in) :: m
      real(kind=c_double), intent(in) :: d
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      mul_m32_d%xx = m%xx * d
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32mat) function mul_i_m32(i,m)
      integer(kind=c_int), intent(in) :: i
      type(fdps_f32mat), intent(in) :: m
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      mul_i_m32%xx = i * m%xx
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32mat) function mul_f_m32(f,m)
      real(kind=c_float), intent(in) :: f
      type(fdps_f32mat), intent(in) :: m
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      mul_f_m32%xx = f * m%xx
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32mat) function mul_d_m32(d,m)
      real(kind=c_double), intent(in) :: d
      type(fdps_f32mat), intent(in) :: m
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      mul_d_m32%xx = d * m%xx
   ...
   !####################################################################
   elemental type(fdps_f64mat) function mul_m64_i(m,i)
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function mul_m64_f(m,f)
      type(fdps_f64mat), intent(in) :: m
      real(kind=c_float), intent(in) :: f
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      mul_m64_f%xx = m%xx * f
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function mul_m64_d(m,d)
      type(fdps_f64mat), intent(in) :: m
      real(kind=c_double), intent(in) :: d
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      mul_m64_d%xx = m%xx * d
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function mul_i_m64(i,m)
      integer(kind=c_int), intent(in) :: i
      type(fdps_f64mat), intent(in) :: m
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      mul_i_m64%xx = i * m%xx
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function mul_f_m64(f,m)
      real(kind=c_float), intent(in) :: f
      type(fdps_f64mat), intent(in) :: m
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      mul_f_m64%xx = f * m%xx
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function mul_d_m64(d,m)
      real(kind=c_double), intent(in) :: d
      type(fdps_f64mat), intent(in) :: m
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      mul_d_m64%xx = d * m%xx
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32mat) function mul_m32_m32(a,b)
      type(fdps_f32mat), intent(in) :: a,b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function mul_m64_m32(a,b)
      type(fdps_f64mat), intent(in) :: a
      type(fdps_f32mat), intent(in) :: b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function mul_m32_m64(a,b)
      type(fdps_f32mat), intent(in) :: a
      type(fdps_f64mat), intent(in) :: b
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function mul_m64_m64(a,b)
   ...
   !####################################################################
   elemental type(fdps_f32mat) function div_m32_i(m,i)
      type(fdps_f32mat), intent(in) :: m
      integer(kind=c_int), intent(in) :: i
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      div_m32_i%xx = m%xx / i
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32mat) function div_m32_f(m,f)
      type(fdps_f32mat), intent(in) :: m
      real(kind=c_float), intent(in) :: f
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      div_m32_f%xx = m%xx / f
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f32mat) function div_m32_d(m,d)
      type(fdps_f32mat), intent(in) :: m
      real(kind=c_double), intent(in) :: d
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      div_m32_d%xx = m%xx / d
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function div_m64_i(m,i)
      type(fdps_f64mat), intent(in) :: m
      integer(kind=c_int), intent(in) :: i
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      div_m64_i%xx = m%xx / i
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function div_m64_f(m,f)
      type(fdps_f64mat), intent(in) :: m
      real(kind=c_float), intent(in) :: f
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      div_m64_f%xx = m%xx / f
   ...
   !--------------------------------------------------------------------
   elemental type(fdps_f64mat) function div_m64_d(m,d)
      type(fdps_f64mat), intent(in) :: m
      real(kind=c_double), intent(in) :: d
#ifndef PARTICLE_SIMULATOR_TWO_DIMENSION
      div_m64_d%xx = m%xx / d
