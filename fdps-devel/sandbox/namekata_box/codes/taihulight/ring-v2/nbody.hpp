...
void CalcForceLoopMerge(Ttree  & tree,
    ...
    for(PS::S32 i=0; i<n_loop_merge; i++){
        ...
        if(PS::Comm::getRank() == 0){
            ...
            /*
            fout_wtime<<"hit_ratio_max= "<<hit_ratio_max<<" hit_ratio_min= "<<hit_ratio_min<<std::endl;
            fout_wtime<<"disp_walk_ex_ptcl_max= "<<disp_walk_ex_ptcl_max<<" rank_disp_walk_ex_ptcl_max= "<<rank_disp_walk_ex_ptcl_max<<std::endl;
            fout_wtime<<"disp_walk_ex_ptcl_min= "<<disp_walk_ex_ptcl_min<<" rank_disp_walk_ex_ptcl_min= "<<rank_disp_walk_ex_ptcl_min<<std::endl;
            fout_wtime<<"n_not_move_max= "<<n_not_move_max<<" n_not_move_min= "<<n_not_move_min<<std::endl;
            fout_wtime<<"n_disp_walk_ex_ptcl_max= "<<n_disp_walk_ex_ptcl_max<<" n_disp_walk_ex_ptcl_min= "<<n_disp_walk_ex_ptcl_min<<std::endl;
            if(n_disp_walk_ex_ptcl_max != n_not_move_max){
                fout_wtime<<"disp_walk_ex_ptcl_max/(n_disp_walk_ex_ptcl_max-n_not_move_max)= "
                          <<(double)disp_walk_ex_ptcl_max/(n_disp_walk_ex_ptcl_max-n_not_move_max)
                          <<std::endl;
            }
            if(n_disp_walk_ex_ptcl_min != n_not_move_min){
                fout_wtime<<"disp_walk_ex_ptcl_min/(n_disp_walk_ex_ptcl_min-n_not_move_min)= "
