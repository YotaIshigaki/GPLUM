...
#MY_DIR = /home/export/base/nsccwuxi_riken/riken/iwasawa_box/submit_job_gb_10k
...
submit_gb_80k:
	ssh $(NSCCWX) "cd $(MY_DIR); \
	bsub -I -b -q q_sw_gb -n 80000 -cgsp 64 -share_size 7000 -host_stack 450 ./$(TARGET) -N 10000000 -n 1024 -t 0.5 -l 16 > 00stdout.log 2>&1"
