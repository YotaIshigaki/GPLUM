...
void readAttribute( Group *group , string attrName , void* attrValue , PredType type ) {
    ...
    Attribute *attr = NULL;
      try{
	attr = new Attribute( group->openAttribute( attrName ) );
      } catch (AttributeIException e){
	string msg = "Can't find Attribute [/"+attrName+"] on HDF snapshot file";
...
CompType* BoxDataset::createCompType() {
    ...
    //
    datatype->insertMember( "SizeX" , HOFFSET(BoxDatatype,SizeX) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "SizeY" , HOFFSET(BoxDatatype,SizeY) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "SizeZ" , HOFFSET(BoxDatatype,SizeZ) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "Type" , HOFFSET(BoxDatatype,Type) , PredType::NATIVE_LLONG );
    datatype->insertMember( "BetaAngle1" , HOFFSET(BoxDatatype,BetaAngle1) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "BetaAngle2" , HOFFSET(BoxDatatype,BetaAngle2) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "BetaAngle3" , HOFFSET(BoxDatatype,BetaAngle3) , PredType::NATIVE_DOUBLE );
    //
#ifdef SNAPSHOT_DEBUG
...
CompType* AtomDataset::createCompType() {
    ...
    //
    datatype->insertMember( "AtomId"    , HOFFSET(AtomDatatype,AtomId)    , PredType::NATIVE_LLONG  );
    datatype->insertMember( "PositionX" , HOFFSET(AtomDatatype,PositionX) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "PositionY" , HOFFSET(AtomDatatype,PositionY) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "PositionZ" , HOFFSET(AtomDatatype,PositionZ) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "Charge"    , HOFFSET(AtomDatatype,Charge)    , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "VelocityX" , HOFFSET(AtomDatatype,VelocityX) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "VelocityY" , HOFFSET(AtomDatatype,VelocityY) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "VelocityZ" , HOFFSET(AtomDatatype,VelocityZ) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "ForceX"    , HOFFSET(AtomDatatype,ForceX)    , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "ForceY"    , HOFFSET(AtomDatatype,ForceY)    , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "ForceZ"    , HOFFSET(AtomDatatype,ForceZ)    , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "Mass"      , HOFFSET(AtomDatatype,Mass)      , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "InverseMass" , HOFFSET(AtomDatatype,InverseMass) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "AtomType"  , HOFFSET(AtomDatatype,AtomType)  , PredType::NATIVE_LLONG  );
    //
#ifdef SNAPSHOT_DEBUG
...
CompType* TyperangeDataset::createCompType() {
    ...
    //
    datatype->insertMember( "Begin"   , HOFFSET(TyperangeDatatype,Begin)   , PredType::NATIVE_LLONG  );
    datatype->insertMember( "End"     , HOFFSET(TyperangeDatatype,End)     , PredType::NATIVE_LLONG  );
    datatype->insertMember( "LJBegin" , HOFFSET(TyperangeDatatype,LJBegin) , PredType::NATIVE_LLONG  );
    datatype->insertMember( "LJEnd"   , HOFFSET(TyperangeDatatype,LJEnd)   , PredType::NATIVE_LLONG  );
    datatype->insertMember( "LJCoulombBegin", HOFFSET(TyperangeDatatype,LJCoulombBegin), PredType::NATIVE_LLONG  );
    datatype->insertMember( "LJCoulombEnd", HOFFSET(TyperangeDatatype,LJCoulombEnd), PredType::NATIVE_LLONG  );
    datatype->insertMember( "CoulombBegin", HOFFSET(TyperangeDatatype,CoulombBegin), PredType::NATIVE_LLONG  );
    datatype->insertMember( "CoulombEnd", HOFFSET(TyperangeDatatype,CoulombEnd), PredType::NATIVE_LLONG  );
    //
#ifdef SNAPSHOT_DEBUG
...
CompType* BondDataset::createMemType() {
    ...
    datatype->insertMember( "AtomId0" , HOFFSET(BondDatatype,AtomId0) , PredType::NATIVE_LLONG );
    datatype->insertMember( "AtomId1" , HOFFSET(BondDatatype,AtomId1) , PredType::NATIVE_LLONG );
    datatype->insertMember( "TypeOfBond" , HOFFSET(BondDatatype,TypeOfBond) , PredType::NATIVE_LLONG );
    datatype->insertMember( "Shake" , HOFFSET(BondDatatype,Shake) , PredType::NATIVE_LLONG );
    return datatype;
}
...
CompType* AngleDataset::createMemType() {
    ...
    datatype->insertMember( "AtomId0" , HOFFSET(AngleDatatype,AtomId0) , PredType::NATIVE_LLONG );
    datatype->insertMember( "AtomId1" , HOFFSET(AngleDatatype,AtomId1) , PredType::NATIVE_LLONG );
    datatype->insertMember( "AtomId2" , HOFFSET(AngleDatatype,AtomId2) , PredType::NATIVE_LLONG );
    datatype->insertMember( "TypeOfAngle" , HOFFSET(AngleDatatype,TypeOfAngle) , PredType::NATIVE_LLONG );
    //
    return datatype;
}
...
CompType* TorsionDataset::createMemType() {
    ...
    datatype->insertMember( "AtomId0" , HOFFSET(TorsionDatatype,AtomId0) , PredType::NATIVE_LLONG );
    datatype->insertMember( "AtomId1" , HOFFSET(TorsionDatatype,AtomId1) , PredType::NATIVE_LLONG );
    datatype->insertMember( "AtomId2" , HOFFSET(TorsionDatatype,AtomId2) , PredType::NATIVE_LLONG );
    datatype->insertMember( "AtomId3" , HOFFSET(TorsionDatatype,AtomId3) , PredType::NATIVE_LLONG );
    datatype->insertMember( "TypeOfTorsion" , HOFFSET(TorsionDatatype,TypeOfTorsion) , PredType::NATIVE_LLONG );
    datatype->insertMember( "Calc14" , HOFFSET(TorsionDatatype,Calc14) , PredType::NATIVE_LLONG );
    //
    return datatype;
}
...
CompType* ImproperDataset::createMemType() {
    ...
    datatype->insertMember( "AtomId0" , HOFFSET(ImproperDatatype,AtomId0) , PredType::NATIVE_LLONG );
    datatype->insertMember( "AtomId1" , HOFFSET(ImproperDatatype,AtomId1) , PredType::NATIVE_LLONG );
    datatype->insertMember( "AtomId2" , HOFFSET(ImproperDatatype,AtomId2) , PredType::NATIVE_LLONG );
    datatype->insertMember( "AtomId3" , HOFFSET(ImproperDatatype,AtomId3) , PredType::NATIVE_LLONG );
    datatype->insertMember( "TypeOfImproper" , HOFFSET(ImproperDatatype,TypeOfImproper) , PredType::NATIVE_LLONG );
    //
    return datatype;
}
...
CompType* BondNumberDataset::createCompType() {
#ifdef SNAPSHOT_DEBUG
    cout << "##### BondNumberDataset::createCompType() start ####" << endl;
#endif
    //
    CompType* datatype = new CompType( sizeof( BondNumberDatatype ) );
    //
    datatype->insertMember( "NumberOfBond" , HOFFSET(BondNumberDatatype,NumberOfBond) , PredType::NATIVE_LLONG );
    datatype->insertMember( "NumberOfAngle" , HOFFSET(BondNumberDatatype,NumberOfAngle) , PredType::NATIVE_LLONG );
    datatype->insertMember( "NumberOfTrosion" , HOFFSET(BondNumberDatatype,NumberOfTrosion) , PredType::NATIVE_LLONG );
    datatype->insertMember( "NumberOfImproper" , HOFFSET(BondNumberDatatype,NumberOfImproper) , PredType::NATIVE_LLONG );
    //
#ifdef SNAPSHOT_DEBUG
    cout << "##### BondNumberDataset::createCompType() end   ####" << endl;
#endif
    //
    return datatype;
}

void BondNumberDataset::write( Group *group ) {
#ifdef SNAPSHOT_DEBUG
    cout << "##### BondNumberDataset::write() start ####" << endl;
#endif
    //
    DataSpace space;
    CompType* datatype = createCompType();
    //
    DataSet* dataset = new DataSet( group->createDataSet( "BondNumberDataset" , *datatype , space ) );
    dataset->write( &bondnumberDatatype , *datatype );
    delete dataset;
    space.close();
    delete datatype;
    //
#ifdef SNAPSHOT_DEBUG
    cout << "##### BondNumberDataset::write() end   ####" << endl;
#endif
}

void BondNumberDataset::read( Group *group ) {
#ifdef SNAPSHOT_DEBUG
    cout << "##### BondNumberDataset::read() start ####" << endl;
#endif
    //
    CompType* datatype = createCompType();
    //
    DataSet* dataset = new DataSet( group->openDataSet( "BondNumberDataset" ) );
    //
    dataset->read( &bondnumberDatatype , *datatype );
    delete dataset;
    delete datatype;
    //
#ifdef SNAPSHOT_DEBUG
    cout << "##### BondNumberDataset::read() end   ####" << endl;
#endif
}


BondlistGroup::BondlistGroup() {
  bondnumberDataset = new BondNumberDataset();
...
void BondlistGroup::read(Group *bondlistarrayGroup){
  BondNumberDatatype bnum;
  stringstream s;
  s << "BondlistGroup_" << index;
  //  cout << " read " << s.str() << endl;
  ...
  try {
    bondnumberDataset->read(bondlistGroup);
    bnum = *(bondnumberDataset->getBondNumberDatatype());
  } catch( Exception e ) {
    e.printError();
    string msg = "Can't read dataset [BondNumberDataset] on HDF restart file";
    //    throw std::runtime_error(errorPos(msg));
    bnum.NumberOfBond=0;
    bnum.NumberOfAngle=0;
    bnum.NumberOfTrosion=0;
    bnum.NumberOfImproper=0;
    bondnumberDataset->getBondNumberDatatype()->NumberOfBond=0;
    bondnumberDataset->getBondNumberDatatype()->NumberOfAngle=0;
    bondnumberDataset->getBondNumberDatatype()->NumberOfTrosion=0;
    bondnumberDataset->getBondNumberDatatype()->NumberOfImproper=0;
  }
  if(bnum.NumberOfBond>0){
    try {
...
void BondlistGroup::write(Group *bondlistarrayGroup){
  ...
  bondnumberDataset->write(bondlistGroup);
...
CompType* WaterDataset::createCompType() {
    ...
    //
    datatype->insertMember( "OWId0" , HOFFSET(WaterDatatype,OWId0) , PredType::NATIVE_LLONG  );
    datatype->insertMember( "HWId1" , HOFFSET(WaterDatatype,HWId1) , PredType::NATIVE_LLONG  );
    datatype->insertMember( "HWId2" , HOFFSET(WaterDatatype,HWId2) , PredType::NATIVE_LLONG  );
    //
#ifdef SNAPSHOT_DEBUG
...
CompType* ShakeDataset::createCompType() {
    ...
    //
    datatype->insertMember( "HAId0"     , HOFFSET(ShakeDatatype,HAId0)     , PredType::NATIVE_LLONG  );
    datatype->insertMember( "Nh1"       , HOFFSET(ShakeDatatype,Nh1)       , PredType::NATIVE_LLONG  );
    datatype->insertMember( "H1Id1"     , HOFFSET(ShakeDatatype,H1Id1)     , PredType::NATIVE_LLONG  );
    datatype->insertMember( "H1Id2"     , HOFFSET(ShakeDatatype,H1Id2)     , PredType::NATIVE_LLONG  );
    datatype->insertMember( "H1Id3"     , HOFFSET(ShakeDatatype,H1Id3)     , PredType::NATIVE_LLONG  );
    datatype->insertMember( "H1Id4"     , HOFFSET(ShakeDatatype,H1Id4)     , PredType::NATIVE_LLONG  );
    datatype->insertMember( "BondType1" , HOFFSET(ShakeDatatype,BondType1) , PredType::NATIVE_LLONG  );
    datatype->insertMember( "BondType2" , HOFFSET(ShakeDatatype,BondType2) , PredType::NATIVE_LLONG  );
    datatype->insertMember( "BondType3" , HOFFSET(ShakeDatatype,BondType3) , PredType::NATIVE_LLONG  );
    datatype->insertMember( "BondType4" , HOFFSET(ShakeDatatype,BondType4) , PredType::NATIVE_LLONG  );
    //
#ifdef SNAPSHOT_DEBUG
...
CompType* IntegrationDataset::createCompType() {
    ...
    //
    datatype->insertMember( "LJEnergyCorrection" , HOFFSET(IntegrationDatatype,LJEnergyCorrection) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "KineticEnergy" , HOFFSET(IntegrationDatatype,KineticEnergy) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "PotentialEnergy" , HOFFSET(IntegrationDatatype,PotentialEnergy) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "TotalEnergy" , HOFFSET(IntegrationDatatype,TotalEnergy) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "Virial" , HOFFSET(IntegrationDatatype,Virial) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "EtaPosition" , HOFFSET(IntegrationDatatype,EtaPosition) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "EtaVelocity" , HOFFSET(IntegrationDatatype,EtaVelocity) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "EtaForce" , HOFFSET(IntegrationDatatype,EtaForce) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "LogVPosition" , HOFFSET(IntegrationDatatype,LogVPosition) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "LogVVelocity" , HOFFSET(IntegrationDatatype,LogVVelocity) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "LogVForce" , HOFFSET(IntegrationDatatype,LogVForce) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "Volume" , HOFFSET(IntegrationDatatype,Volume) , PredType::NATIVE_DOUBLE );
    //
#ifdef SNAPSHOT_DEBUG
...
CompType* SnapshotDataset::createCompType() {
    ...
    //
    datatype->insertMember( "TimeStepInterval" , HOFFSET(SnapshotDatatype,TimeStepInterval) , PredType::NATIVE_DOUBLE );
    datatype->insertMember( "CurrentTimeStep"  , HOFFSET(SnapshotDatatype,CurrentTimeStep)  , PredType::NATIVE_LLONG );
    datatype->insertMember( "CurrentReductionCounter"  , HOFFSET(SnapshotDatatype,CurrentReductionCounter)  , PredType::NATIVE_LLONG );
    datatype->insertMember( "CurrentPrintCounter"  , HOFFSET(SnapshotDatatype,CurrentPrintCounter)  , PredType::NATIVE_LLONG );
    datatype->insertMember( "CurrentCRDCounter"  , HOFFSET(SnapshotDatatype,CurrentCRDCounter)  , PredType::NATIVE_LLONG );
    datatype->insertMember( "CurrentRSTCounter"  , HOFFSET(SnapshotDatatype,CurrentRSTCounter)  , PredType::NATIVE_LLONG );
    datatype->insertMember( "AtomArrayLength"  , HOFFSET(SnapshotDatatype,AtomArrayLength)  , PredType::NATIVE_LLONG );
    //
#ifdef SNAPSHOT_DEBUG
...
void SnapshotGroup::write( Group* rootGroup ) {
  ...
  void SnapshotGroup::read( Group* rootGroup , size_t step, int verbose ) {
#ifdef SNAPSHOT_DEBUG
    cout << "##### SnapshotGroup::read() start #####" << endl;
#endif
    std::vector<long> steps;
    size_t num_steps;
    size_t use_step = step;
    num_steps = getsteps(rootGroup,steps);

    std::vector<long>::iterator it = find(steps.begin(),steps.end(), (long)step);
    if(it==steps.end()){
      cout << "Not found Step " << step << std::endl;
      if(step>=num_steps){
	use_step = steps[num_steps-1];
	cout << "Number of step is smaller than " << step << ". Use last step " << use_step << endl;
      }else{
	use_step = steps[step];
	cout << "Use " << use_step << " step : " << step << "th step of founded steps" << endl;
      }
    }
    //
    stringstream s;
...
int SnapshotGroup::getsteps( Group* rootGroup, vector<long>& steps ) {
  //    cout << "##### SnapshotGroup::getsteps() start #####" << endl;
    //
    hsize_t numberOfStep = rootGroup->getNumObjs();
    //    cout << "Number Of Step : " << numberOfStep << endl;
    //    vector<long> steps;
    ...
    std::sort(steps.begin(),steps.end());
    //
    //    cout << "##### SnapshotGroup::getsteps() end #####" << endl;
    return (int)numberOfStep;
}
...
void HDFSnapshotFile::write() {
    ...
    if( isHDF5 <= 0) {
        ...
        //
        try {
            writeAttribute( rootGroup , "NumberOfAtom" , &numberOfAtom , PredType::NATIVE_LLONG );
        } catch( Exception e ) {
            e.printError();
        ...
        try {
            writeAttribute( rootGroup , "Rank" , &rank , PredType::NATIVE_INT );
        } catch( Exception e ) {
            e.printError();
        ...
        try {
            writeAttribute( rootGroup , "NumberOfRank" , &numberOfRank , PredType::NATIVE_INT );
        } catch( Exception e ) {
            e.printError();
        ...
        try {
	  int st = snapshotType;
            writeAttribute( rootGroup , "SnapshotType" , &st , PredType::NATIVE_INT );
        } catch( Exception e ) {
            e.printError();
            string msg = "Can't write attribute [SnapshotType] on HDF snapshot file";
            throw std::runtime_error(errorPos(msg));
        }
        //
        try {
        ...
        try {
            writeAttribute( rootGroup , "NumberOfTimeStep" , &numberOfTimeStep , PredType::NATIVE_LLONG );
        } catch( Exception e ) {
            e.printError();
        ...
        try {
            readAttribute( rootGroup , "NumberOfTimeStep" , &numberOfTimeStep , PredType::NATIVE_LLONG );
        } catch( Exception e ) {
            e.printError();
            string msg = "Can't write attribute [NumberOfTimeStep] on HDF snapshot file";
            throw std::runtime_error(errorPos(msg));
        ...
        ++numberOfTimeStep;
        try {
            updateAttribute( rootGroup , "NumberOfTimeStep" , &numberOfTimeStep , PredType::NATIVE_LLONG );
        } catch( Exception e ) {
            e.printError();
...
void HDFSnapshotFile::read() {
    ...
    Group* rootGroup = new Group( snapshotFile->openGroup( "/" ) );
    //
    readAttribute( rootGroup , "NumberOfRank" , &numberOfRank , PredType::NATIVE_INT );
    cout << " NumberOfRank " << numberOfRank << endl;
    //
    snapshotFile->close();
    //
    if( rootGroup != NULL ) delete rootGroup;
  ...
  void HDFSnapshotFile::read(size_t step,  int verbose) {
    if(verbose>0){
      cout << "##### HDFSnapshotFile::read(" << step << ") start #####" << endl;
    }
    //
    H5File* snapshotFile = new H5File( snapshotFilename , H5F_ACC_RDONLY );
    Group* rootGroup = new Group( snapshotFile->openGroup( "/" ) );
    if(verbose>0){
      std::cout << " oepn group / " << std::endl;
    }

    //    readAttributeString( rootGroup , "ProgramVersion" , programVersion );
    readAttribute( rootGroup , "Rank" , &rank , PredType::NATIVE_INT );
    readAttribute( rootGroup , "NumberOfRank" , &numberOfRank , PredType::NATIVE_INT );
    readAttribute( rootGroup , "SnapshotType" , &snapshotType , PredType::NATIVE_INT );
    ...
    //
      BondlistarrayGroup* bondlistarray = getBondlistarrayGroup();
      cout << "BondlistarrayGroup" << endl;
      long long NumberOfBondlist = bondlistarray->getNumberOfBondlist();
      cout << "  NumberOfBondlist " << NumberOfBondlist << endl;
      BondNumberDatatype totalbnum = {0,0,0,0};
      for( int n=0;n<NumberOfBondlist;n++){
	BondNumberDatatype* bondnum = bondlistarray->getBondlistGroup(n)->getBondNumberDataset()->getBondNumberDatatype();
#if 0
	if((bondnum->NumberOfBond>0)||(bondnum->NumberOfAngle>0)||(bondnum->NumberOfTrosion>0)||(bondnum->NumberOfImproper>0)){
	  cout << "  Bondlis(" << n << ") Bond " << bondnum->NumberOfBond << " Angle " << bondnum->NumberOfAngle << " Torsion " << bondnum->NumberOfTrosion << " Improper " << bondnum->NumberOfImproper << endl;
	}
#endif 
	totalbnum.NumberOfBond += bondnum->NumberOfBond;
	totalbnum.NumberOfAngle += bondnum->NumberOfAngle;
	totalbnum.NumberOfTrosion += bondnum->NumberOfTrosion;
	totalbnum.NumberOfImproper += bondnum->NumberOfImproper;
      }
      cout << "   Total  Bond " << totalbnum.NumberOfBond << " Angle " << totalbnum.NumberOfAngle << " Torsion " << totalbnum.NumberOfTrosion << " Improper " << totalbnum.NumberOfImproper << endl;
    }
    //
    if( rootGroup != NULL ) delete rootGroup;
    if( snapshotFile != NULL ) delete snapshotFile;
...
void HDFSnapshotFile::outputInfo() {
    ...
    try{
      ...
      cout << "assume SnapshotType is Single" << endl;
      snapshottype = Single;
    }
    cout << "SnapshotType    : " <<  snapshottype << endl;
