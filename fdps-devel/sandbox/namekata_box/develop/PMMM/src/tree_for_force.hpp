...
namespace ParticleSimulator{
    ...
    public:
        ...
        F64 theta_;
        S32 pfmm_; // the order of multipole expansion
        ...
        S32 level_pm_cell_; // the tree level of a PM cell
...
// new 
        ...
        void initialize(const U64 n_glb_tot,
                        const PMM::ParticleMeshMultipoleParameters & param,
                        const F64 theta=FDPS_DFLT_VAL_THETA,
                        const U32 n_leaf_limit=FDPS_DFLT_VAL_N_LEAF_LIMIT,
                        const U32 n_group_limit=FDPS_DFLT_VAL_N_GROUP_LIMIT);
        ...
        */
        ...
        /////////////////////////////
        // for APIs for PMMM-mode
        PMM::ParticleMeshMultipoleParameters getParticleMeshMultipoleParameters(const DomainInfo & dinfo) const;
