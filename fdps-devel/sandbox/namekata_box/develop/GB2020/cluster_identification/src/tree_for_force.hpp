...
// new 
        ...
        */
        ...
        ////////////////////
        // for cluster finding APIs
        std::vector<ClusterInfo> getClusterList(const F64 dt_crit);
        std::vector<F64ort> getClusterListImpl(TagSearchShortGather, const F64 dt_crit);
        std::vector<F64ort> getClusterListImpl(TagSearchShortScatter, const F64 dt_crit);
        std::vector<F64ort> getClusterListImpl(TagSearchShortSymmetry, const F64 dt_crit);
