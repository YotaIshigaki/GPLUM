...
namespace ParticleSimulator{
    ...
    public:
        ...
        //F64vec center_; // new member (not used)
        F64ort pos_root_cell_;
        F64ort pos_unit_cell_; // the domain size of the particle mesh for PMM and it is
                               // used as the reference position for Morton key calculation.
        S32vec idx_unit_cell_; // If we divide pos_root_cell into PM cells and PM cells are
        ...
        bool first_call_decomposeParticleMeshCell_;
        std::vector<S32> * list_pm_cell_for_mm_;
        std::vector<S32> list_pm_cell_shared_for_mm_;
        std::vector<S32> list_pm_cell_loc_;
        MultientranceArray<S32> rnklst_from_pm_cell_idx_;
        std::unordered_map< S32, IParticleInfo<Tepi, Tforce> > ip_info_pm_cell_; // i particle information of PM cell
        std::unordered_map< S32, S32 > adr_tc_glb_from_pm_cell_idx_; // j particle information of PM cell
...
// probably, calcMomentGlobalTreeOnlyImpl is classified depending on force_type.
        ...
        void calcCenterAndLengthOfRootCell(TagSearchLongParticleMeshMultipole,
                                           const DomainInfo & dinfo) {
            calcCenterAndLengthOfRootCellImpl(epj_org_.getPointer(), dinfo);
        }
        ...
        void repositionPosRootCellToEmbedParticleMesh(TagSearchLong) {}
        void repositionPosRootCellToEmbedParticleMesh(TagSearchLongCutoff) {}
        void repositionPosRootCellToEmbedParticleMesh(TagSearchLongScatter) {}
        void repositionPosRootCellToEmbedParticleMesh(TagSearchLongSymmetry) {}
        void repositionPosRootCellToEmbedParticleMesh(TagSearchLongCutoffScatter) {}
        void repositionPosRootCellToEmbedParticleMesh(TagSearchLongParticleMeshMultipole) {
            repositionPosRootCellToEmbedParticleMeshImpl();
        }
        void repositionPosRootCellToEmbedParticleMesh(TagSearchShortScatter) {}
        void repositionPosRootCellToEmbedParticleMesh(TagSearchShortGather) {}
        void repositionPosRootCellToEmbedParticleMesh(TagSearchShortSymmetry) {}
...
// new 
        ...
        TreeForForce() : is_initialized_(false), first_call_decomposeParticleMeshCell_(true) {}
        ~TreeForForce(){
            delete [] n_cell_open_;
        ...
        */
        ...
        void calcEpiInfoOfParticleMeshCell() {
            calcEpiInfoOfParticleMeshCellImpl(typename TSM::search_type());
        }
        void calcEpiInfoOfParticleMeshCellImpl(TagSearchShortGather) {}
        void calcEpiInfoOfParticleMeshCellImpl(TagSearchShortScatter) {}
        void calcEpiInfoOfParticleMeshCellImpl(TagSearchShortSymmetry) {}
        void calcEpiInfoOfParticleMeshCellImpl(TagSearchLong) {}
        void calcEpiInfoOfParticleMeshCellImpl(TagSearchLongCutoff) {}
        void calcEpiInfoOfParticleMeshCellImpl(TagSearchLongParticleMeshMultipole) {
            ip_info_pm_cell_.clear();
            CalcEpiInfoOfParticleMeshCell
                <TSM, TreeCell<Tmomloc>, TreeParticle, Tepi, 
                 IParticleInfo<Tepi, Tforce> >
                (adr_tc_level_partition_loc_,
                 tc_loc_, tp_glb_, epi_sorted_,
                 n_cell_, level_pm_cell_, ip_info_pm_cell_);
        }
        void calcEpiInfoOfParticleMeshCellImpl(TagSearchLongScatter) {}
        void calcEpiInfoOfParticleMeshCellImpl(TagSearchLongSymmetry) {}

        void calcJParticleInfoOfParticleMeshCell() {
            calcJParticleInfoOfParticleMeshCellImpl(typename TSM::search_type());
        }
        void calcJParticleInfoOfParticleMeshCellImpl(TagSearchShortGather) {}
        void calcJParticleInfoOfParticleMeshCellImpl(TagSearchShortScatter) {}
        void calcJParticleInfoOfParticleMeshCellImpl(TagSearchShortSymmetry) {}
        void calcJParticleInfoOfParticleMeshCellImpl(TagSearchLong) {}
        void calcJParticleInfoOfParticleMeshCellImpl(TagSearchLongCutoff) {}
        void calcJParticleInfoOfParticleMeshCellImpl(TagSearchLongParticleMeshMultipole) {
            CalcJParticleInfoOfParticleMeshCell
                <TSM, TreeCell<Tmomglb>, TreeParticle>
                (adr_tc_level_partition_glb_,
                 tc_glb_, tp_glb_,
                 epj_sorted_, spj_sorted_, // for the convenience of debugging
                 n_cell_, level_pm_cell_, adr_tc_glb_from_pm_cell_idx_);
        }
        void calcJParticleInfoOfParticleMeshCellImpl(TagSearchLongScatter) {}
        void calcJParticleInfoOfParticleMeshCellImpl(TagSearchLongSymmetry) {}

        void calcForceInfoOfParticleMeshCell() {
            calcForceInfoOfParticleMeshCellImpl(typename TSM::search_type());
        }
        void calcForceInfoOfParticleMeshCellImpl(TagSearchShortGather) {}
        void calcForceInfoOfParticleMeshCellImpl(TagSearchShortScatter) {}
        void calcForceInfoOfParticleMeshCellImpl(TagSearchShortSymmetry) {}
        void calcForceInfoOfParticleMeshCellImpl(TagSearchLong) {}
        void calcForceInfoOfParticleMeshCellImpl(TagSearchLongCutoff) {}
        void calcForceInfoOfParticleMeshCellImpl(TagSearchLongParticleMeshMultipole) {
            for (auto itr = ip_info_pm_cell_.begin(); itr != ip_info_pm_cell_.end(); ++itr) {
        ...
        void calcForceInfoOfParticleMeshCellImpl(TagSearchLongScatter) {}
        void calcForceInfoOfParticleMeshCellImpl(TagSearchLongSymmetry) {}
        ...
        std::vector<S32> getListOfParticleMeshCellIndex(const S32 i) const;
        std::vector<S32> getListOfSharedParticleMeshCellIndex() const;
        std::vector<S32> getListOfLocalParticleMeshCellIndex() const;
        MultientranceArray<S32> getRankListFromParticleMeshCellIndex() const;

        S32 getIParticleInfoOfParticleMeshCell(const S32 idx, IParticleInfo<Tepi, Tforce> & info);

        template <class real_t, class cplx_t>
        S32 calcMultipoleMomentOfParticleMeshCell(const S32 idx,
                                                  const F64vec & center,
                                                  const F64ort & pos_my_domain,
                                                  MultipoleMoment<real_t, cplx_t> & mm,
                                                  const S32 p_spj2mm) const;
        void calcTotalChargeAndDispersionOfParticleMeshCell(const S32 idx, 
                                                            const F64vec & center,
                                                            const F64ort & pos_my_domain,
                                                            F64 & msum, F64 & quad0) const;
        ...
        void calcForceMakingTree(Tfunc_ep_ep pfunc_ep_ep, 
            ...
            if(list_mode == MAKE_LIST || list_mode == MAKE_LIST_FOR_REUSE){
                ...
                calcEpiInfoOfParticleMeshCell(); // epi 
                ...
                calcJParticleInfoOfParticleMeshCell(); // epj and spj
                ...
                calcForceInfoOfParticleMeshCell(); // force
...
#pragma omp parallel for
    ...
    public:
        ...
        // for PM^3
        using MonopoleParticleMeshMultipole
            = TreeForForce<SEARCH_MODE_LONG_PARTICLE_MESH_MULTIPOLE,
                           Tforce, Tepi, Tepj,
                           MomentMonopolePMMM,
                           MomentMonopolePMMM,
                           SPJMonopolePMMM> ;

        using QuadrupoleParticleMeshMultipole
            = TreeForForce<SEARCH_MODE_LONG_PARTICLE_MESH_MULTIPOLE,
                           Tforce, Tepi, Tepj,
                           MomentQuadrupolePMMM,
                           MomentQuadrupolePMMM,
                           SPJQuadrupolePMMM> ;

        using MonopoleGeometricCenterParticleMeshMultipole
            = TreeForForce<SEARCH_MODE_LONG_PARTICLE_MESH_MULTIPOLE,
                           Tforce, Tepi, Tepj,
        ...
        using DipoleGeometricCenterParticleMeshMultipole
            = TreeForForce<SEARCH_MODE_LONG_PARTICLE_MESH_MULTIPOLE,
                           Tforce, Tepi, Tepj,
                           MomentDipoleGeometricCenterPMMM,
                           MomentDipoleGeometricCenterPMMM,
                           SPJDipoleGeometricCenterPMMM> ;

        using QuadrupoleGeometricCenterParticleMeshMultipole
            = TreeForForce<SEARCH_MODE_LONG_PARTICLE_MESH_MULTIPOLE,
                           Tforce, Tepi, Tepj,
                           MomentQuadrupoleGeometricCenterPMMM,
                           MomentQuadrupoleGeometricCenterPMMM,
                           SPJQuadrupoleGeometricCenterPMMM> ;

#ifdef PARTICLE_SIMULATOR_PMM_EXPERIMENTAL_FEATURE
        template <int p>
        using MultipoleGeometricCenterParticleMeshMultipole
            = TreeForForce<SEARCH_MODE_LONG_PARTICLE_MESH_MULTIPOLE,
                           Tforce, Tepi, Tepj,
                           MomentMultipoleGeometricCenterPMMM<p>,
                           MomentMultipoleGeometricCenterPMMM<p>,
                           SPJMultipoleGeometricCenterPMMM<p> > ;
#endif
    };
