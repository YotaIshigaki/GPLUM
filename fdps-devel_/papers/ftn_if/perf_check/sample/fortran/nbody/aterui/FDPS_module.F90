...
module FDPS_module
   ...
   contains
      ...
      procedure, private :: get_epj_from_id00000
      generic :: get_epj_from_id => get_epj_from_id00000
      !-----------------------------------------------
      !-(MPI comm. functions)
      procedure :: get_rank 
   ...
   interface
      ...
      subroutine fdps_sort_particle00000(psys_num,pfunc_comp) bind(c)
         use, intrinsic :: iso_c_binding
         use user_defined_types
         implicit none
         integer(kind=c_int), value, intent(in) :: psys_num
         type(c_funptr), value, intent(in) :: pfunc_comp
      end subroutine fdps_sort_particle00000
   ...
   subroutine sort_particle(this,psys_num,pfunc_comp)
      ...
      case("full_particle")
         call fdps_sort_particle00000(psys_num,pfunc_comp)
   ...
   subroutine get_neighbor_list00000(this,tree_num,pos,r_search,num_epj,fptr_to_EPJ)
      ...
      case default
         errmsg =  "EssentialParticleJ specified does not have " &
                ...
                // "neighbor search."
         func_name = "get_neighbor_list00000"
         call print_errmsg(errmsg,func_name)
   ...
   subroutine get_epj_from_id00000(this,tree_num,id,fptr_to_EPJ)
      use user_defined_types
      use fdps_vector
      implicit none
      class(FDPS_controller) :: this
      ...
      type(full_particle), pointer, intent(INOUT) :: fptr_to_EPJ
      !* Local parameters
      integer, parameter :: bufsize=256
      !* Local variables
      character(len=bufsize,kind=c_char) :: info
      ...
      case default
         ...
         func_name = "get_epj_from_id00000"
         call print_errmsg(errmsg,func_name)
         !* Additional information
         write(*,100)"full_particle",trim(info)
         100 format("Please check the definitions of EssentialParticleJ"/ &
   ...
   end subroutine get_epj_from_id00000
   ...
   subroutine broadcast_scalar_i32(this,val,n,src)
      use, intrinsic :: iso_c_binding
      implicit none
      class(FDPS_controller) :: this
      integer(kind=c_int), intent(INOUT) :: val
   ...
   subroutine broadcast_scalar_i64(this,val,n,src)
      use, intrinsic :: iso_c_binding
      implicit none
      class(FDPS_controller) :: this
      integer(kind=c_long_long), intent(INOUT) :: val
   ...
   subroutine broadcast_scalar_r32(this,val,n,src)
      use, intrinsic :: iso_c_binding
      implicit none
      class(FDPS_controller) :: this
      real(kind=c_float), intent(INOUT) :: val
   ...
   subroutine broadcast_scalar_r64(this,val,n,src)
      use, intrinsic :: iso_c_binding
      implicit none
      class(FDPS_controller) :: this
      real(kind=c_double), intent(INOUT) :: val
