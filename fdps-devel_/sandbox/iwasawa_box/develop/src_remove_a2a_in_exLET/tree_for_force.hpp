...
PS_OMP_PARALLEL_FOR
    ...
    public:
        ...
        void setExchagneLETMode(enum EXCHANGE_LET_MODE elm){
        ...
        */
        ...
        void setLocalEssentialTreeToGlobalTreeImpl(TagForceLong,
                                                   const bool flag_reuse = false){
            SetLocalEssentialTreeToGlobalTreeLong(epj_org_, spj_org_, n_loc_tot_, tp_glb_, flag_reuse);
            n_let_sp_ = spj_org_.size();
            //std::cerr<<"n_let_sp_= "<<n_let_sp_<<std::endl;
        }
        void setLocalEssentialTreeToGlobalTreeImpl(TagForceShort,
                                                    const bool flag_reuse = false){
            SetLocalEssentialTreeToGlobalTreeShort(epj_org_, n_loc_tot_, tp_glb_, flag_reuse);
        }
