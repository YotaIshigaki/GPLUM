...
#if !defined(DEBUG)
#ifdef WITHOUT_TRANSPOSE_BACK
    // Allocate buffers
    ptrdiff_t alloc_local, local_n0, local_0_start;
    alloc_local = fftw_mpi_local_size_3d(NC, NC, NC/2+1, comm,
...
#else
    fftw_plan plan_fwd = fftw_mpi_plan_dft_r2c_3d(NZ, NY, NX, rbuf, kbuf,
                                                  comm,FFTW_EXHAUSTIVE | FFTW_MPI_SCRAMBLED_OUT);
    fftw_plan plan_bkw = fftw_mpi_plan_dft_c2r_3d(NZ, NY, NX, kbuf, rbuf,
                                                  comm,FFTW_EXHAUSTIVE | FFTW_MPI_SCRAMBLED_IN);
#endif
#else
    fftw_plan plan_fwd = fftw_mpi_plan_dft_r2c_3d(NZ, NY, NX, rbuf, kbuf,
                                                  comm,FFTW_EXHAUSTIVE);
