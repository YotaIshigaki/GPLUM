...
double __ieee754_atan2(double y, double x, double * ah, double * al, double * at )
{
	...
	//if((hx-0x3ff00000|lx)==0) return atan(y);   /* x=1.0 */
        if((hx-0x3ff00000|lx)==0) return atan(y, ah, al, at);   /* x=1.0 */
	...
	//else z=atan(fabs(y/x));		/* safe to do y/x */
        else z=atan(fabs(y/x), ah, al, at);		/* safe to do y/x */
	switch (m) {
