        ...
        if (tc_tgt->n_ptcl_ == 0) {
            ...
            for (j=0; j<tc_tgt->n_ptcl_; j+= CHUNK_SIZE) {
                ...
                for (k=0; k<nn; k++){
                   ...
                   /*
                   tc_tgt->pos_phi += epj[k].mass * epj[k].pos_phi;
                   tc_tgt->pos_r   += epj[k].mass * epj[k].pos_r;

                   tc_tgt->vertex_out_.low_.x = ( tc_tgt->vertex_out_.low_.x <= epj[k].pos_phi - *rsrch) ? tc_tgt->vertex_out_.low_.x : epj[k].pos_phi - *rsrch;
                   tc_tgt->vertex_out_.low_.y = ( tc_tgt->vertex_out_.low_.y <= epj[k].pos_r - *rsrch) ? tc_tgt->vertex_out_.low_.y : epj[k].pos_r - *rsrch;
                   tc_tgt->vertex_out_.low_.z = ( tc_tgt->vertex_out_.low_.z <= epj[k].pos.z - *rsrch) ? tc_tgt->vertex_out_.low_.z : epj[k].pos.z - *rsrch;
                   tc_tgt->vertex_out_.high_.x = ( tc_tgt->vertex_out_.high_.x > epj[k].pos_phi + *rsrch) ? tc_tgt->vertex_out_.high_.x : epj[k].pos_phi + *rsrch;
                   tc_tgt->vertex_out_.high_.y = ( tc_tgt->vertex_out_.high_.y > epj[k].pos_r + *rsrch) ? tc_tgt->vertex_out_.high_.y : epj[k].pos_r + *rsrch;
                   tc_tgt->vertex_out_.high_.z = ( tc_tgt->vertex_out_.high_.z > epj[k].pos.z + *rsrch) ? tc_tgt->vertex_out_.high_.z : epj[k].pos.z + *rsrch;

                   tc_tgt->vertex_in_.low_.x = ( tc_tgt->vertex_in_.low_.x <= epj[k].pos_phi - *rsrch) ? tc_tgt->vertex_in_.low_.x : epj[k].pos_phi - *rsrch;
                   tc_tgt->vertex_in_.low_.y = ( tc_tgt->vertex_in_.low_.y <= epj[k].pos_r - *rsrch) ? tc_tgt->vertex_in_.low_.y : epj[k].pos_r - *rsrch;
                   tc_tgt->vertex_in_.low_.z = ( tc_tgt->vertex_in_.low_.z <= epj[k].pos.z - *rsrch) ? tc_tgt->vertex_in_.low_.z : epj[k].pos.z - *rsrch;
                   tc_tgt->vertex_in_.high_.x = ( tc_tgt->vertex_in_.high_.x > epj[k].pos_phi + *rsrch) ? tc_tgt->vertex_in_.high_.x : epj[k].pos_phi + *rsrch;
                   tc_tgt->vertex_in_.high_.y = ( tc_tgt->vertex_in_.high_.y > epj[k].pos_r + *rsrch) ? tc_tgt->vertex_in_.high_.y : epj[k].pos_r + *rsrch;
                   tc_tgt->vertex_in_.high_.z = ( tc_tgt->vertex_in_.high_.z > epj[k].pos.z + *rsrch) ? tc_tgt->vertex_in_.high_.z : epj[k].pos.z + *rsrch;
                   */
#else
