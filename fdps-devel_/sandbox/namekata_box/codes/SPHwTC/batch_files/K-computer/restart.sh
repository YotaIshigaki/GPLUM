...
mpiexec -n 2048 ./sph.x.rst -Wl,-T
#mpiexec -n 512 ./sph.x.rst -debuglib -Wl,-T > 00stdout.log 2>&1
#fipp -C -Icall,hwm -d profile_data -m 40000 mpiexec -n 512 ./sph.x.rst -Wl,-T
#fapp -C -Impi,hwm -Hevent=Cache,mode=sys,method=normal -d profile_data mpiexec -n 512 ./sph.x.rst -Wl,-T
