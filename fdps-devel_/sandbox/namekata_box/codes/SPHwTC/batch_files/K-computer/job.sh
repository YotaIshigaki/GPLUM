...
mpiexec --debuglib -n 512 ./sph.x -Wl,-T
#mpiexec -n 512 ./sph.x -Wl,-T
#mpiexec -n 2048 ./sph.x -Wl,-T
#mpiexec -n 4096 ./sph.x -Wl,-T
#mpiexec -n 512 ./sph.x -debuglib -Wl,-T > 00stdout.log 2>&1
